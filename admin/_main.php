...
<head>
    ...
    <link href="/response/asset/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="/member" class="logo"><?php echo $site_name;  ?></a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/cpanel/my" class="btn btn-default btn-flat">个人信息</a>
                                </div>
                                <div class="pull-right">
                                    <a href="/cpanel/logout" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
